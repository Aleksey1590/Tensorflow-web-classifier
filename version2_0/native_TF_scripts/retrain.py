...
def main(_):
  ...
  with tf.Session(graph=graph) as sess:
    ...
    print("")
    print("number of misclassified images: ",len(test_filenames))
    ...
    if FLAGS.print_misclassified_test_images:
      ...
      for i, test_filename in enumerate(test_filenames):
        if predictions[i] != test_ground_truth[i].argmax():
          ...
          print("Trying to copy this file: ", test_filename)
          # shutil.copy2(test_filename,'/Users/alexanderdubilet/Documents/Системное/iphone/misclassified')
